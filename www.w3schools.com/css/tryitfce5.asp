...
<!-- Mirrored from www.w3schools.com/css/tryit.asp?filename=trycss3_transform_skew2 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jun 2022 04:16:46 GMT -->
<head>
...
<div id='breadcrumb'>
<ul>
<li><a href='../default.html' onclick="ga('send', 'event', 'Breadcrumbs', 'Level 1', 'trycss3_transform_skew2')">Home</a></li>
<li><a href='default.html' onclick="ga('send', 'event', 'Breadcrumbs', 'Level 2', 'trycss3_transform_skew2')">CSS</a></li>
<li><a href='css3_2dtransforms.html' onclick="ga('send', 'event', 'Breadcrumbs', 'Level 3', 'trycss3_transform_skew2')">CSS 2D Transforms</a></li>
<li>Tryit: The skew() method</li>
</ul>
</div>
