...
<!-- Mirrored from www.w3schools.com/css/tryit.asp?filename=trycss3_transform_scaleY2 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jun 2022 04:16:46 GMT -->
<head>
...
<link rel="preload" href="../lib/fonts/montserrat-v18-latin-regular.woff2" as="font" type="font/woff2" crossorigin>
...
<div id='breadcrumb'>
<ul>
<li><a href='../default.html' onclick="ga('send', 'event', 'Breadcrumbs', 'Level 1', 'trycss3_transform_scaley2')">Home</a></li>
<li><a href='default.html' onclick="ga('send', 'event', 'Breadcrumbs', 'Level 2', 'trycss3_transform_scaley2')">CSS</a></li>
<li><a href='css3_2dtransforms.html' onclick="ga('send', 'event', 'Breadcrumbs', 'Level 3', 'trycss3_transform_scaley2')">CSS 2D Transforms</a></li>
<li>Tryit: The scaleY() method</li>
</ul>
</div>
...
<span onclick="openMenu()" class="w3-button w3-display-topright w3-transparent ws-hover-black" title="Close Menu" style="font-weight:bold;padding-top:10px;padding-bottom:11px;">&times;</span>
  <div class="w3-bar-block">
    ...
    <a class="w3-bar-item w3-button" style="height: 62px;padding-top: 18px;" href='https://spaces.w3schools.com/' target="_blank" title="Go to Spaces"><img style="margin-left:9px;margin-right:15px;margin-bottom: 8px;" src="https://www.w3schools.com/images/spaces-icon-tryit.svg" /><span style="position:relative;top:-4px;left:2px;">Go to Spaces</span></a>    
  </div>
  ...
  <a style="display:inline;padding:0;" href="../about/about_copyright.html" target="_blank" onclick="openMenu();" class="w3-hover-none ws-hover-text-green">Copyright 1999-2022</a></p>
  </footer>
</div>
...
<script src="../lib/spaceit.js"></script>
